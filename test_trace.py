...
class TestFormatters(unittest.TestCase):
    def test_pretty_found(self):
        out = format_pretty('test_fn', [{'caller': 'caller1', 'callee': 'test_fn', 'file': '/a/b.py', 'line': 10, 'context': ''}], [], '/root', 1)
    ...
    def test_json(self):
        js = format_json('test_fn', [{'caller': 'caller1', 'callee': 'test_fn', 'file': '/a/b.py', 'line': 10, 'context': ''}], [], '/root', 2)
        data = json.loads(js)

...
def test_search_relpath():
    ...
    try:
        with open(tmp, 'w') as f: f.write('relpath_check\n')
...
def test_graph_diamond():
    ...
    try:
        with open(files['A'], 'w') as f: f.write('import B, C\n')
        with open(files['B'], 'w') as f: f.write('import D\n')
        with open(files['C'], 'w') as f: f.write('import D\n')
        with open(files['D'], 'w') as f: f.write('pass\n')

...
[![Tools](https://img.shields.io/static/v1?label=tools&message=20&color=brightgreen)](https://github.com/xxxn3m3s1sxxx/opencode-tools/releases/tag/v0.5.3)
[![Tests](https://img.shields.io/static/v1?label=tests&message=590%2B%20passing&color=brightgreen)](https://github.com/xxxn3m3s1sxxx/opencode-tools/releases/tag/v0.5.3)
